...
public:
	...
	*/
	__forceinline TimeType_t GetTimeElapsed() { return m_iTimePoint - Iter_t::now(); }

	/*
	* Get current time.
	*/
	__forceinline TimeType_t GetCurTime() { return Iter_t::now(); }
