...
namespace L
{
	...
	*/
	...
	public:
		...
		__forceinline bool IsDummy() { return (m_szName.find(XOR("Dummy event!")) == std::string::npos || m_nType == LOG_EVENT_NONE); }

		__forceinline CLogEvent& operator=(CLogEvent Other) { m_szName = Other.m_szName; m_nType = Other.m_nType; return *this; }
